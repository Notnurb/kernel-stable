...
This repository is the **stable** channel. If you want something newer (or wilder),
check out the sibling channels:

* [`kernel-nightly`](https://github.com/Notnurb/kernel-nightly) — nightly development snapshots.
* [`kernel-experimental`](https://github.com/Notnurb/kernel-experimental) — bleeding-edge experiments.
